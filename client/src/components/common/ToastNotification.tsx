...
export const ToastNotification: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl bg-[#0F172A]/95 backdrop-blur-2xl border border-amber-400/30 p-4 shadow-[0_16px_40px_rgba(0,0,0,0.85),0_0_24px_rgba(250,204,21,0.18)] flex items-start gap-3.5">
        {/* Left Icon with subtle glow */}
        <div className="shrink-0 mt-0.5">
          {isSuccess ? (
            <div className="w-8 h-8 rounded-xl bg-amber-400/15 border border-amber-400/30 flex items-center justify-center text-amber-300 shadow-[0_0_12px_rgba(250,204,21,0.3)]">
        ...
        <div className="flex-1 min-w-0 pr-2">
          <h4 className="text-sm font-bold text-slate-100 tracking-tight flex items-center gap-1.5">
        ...
        <button
          ...
          className="shrink-0 text-slate-400 hover:text-white p-1 rounded-lg hover:bg-white/10 transition-all cursor-pointer"
        >
          <X className="w-4 h-4" />
        </button>
